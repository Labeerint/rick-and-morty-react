...
const Character = ({character}) =>{
    ...
    return(
        <div>
            <Card onClick={showModal} title={character.name} extra={character.status === "Alive" ? <Title level={5}><HeartTwoTone twoToneColor="#eb2f96" /> {character.status}</Title> : <h4><FrownOutlined /> {character.status}</h4>} style={{ width: 330, marginTop: 20 }}>
